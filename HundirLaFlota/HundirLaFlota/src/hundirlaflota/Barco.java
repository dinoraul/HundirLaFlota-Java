...
public class Barco {
	...
	private Point[] coordenadas;
        ...
        /**
         * En el contructor pasas el tamaño del barco
         * En el constructor se inicializa el array coordenadas y partesDanadas con el tamaño posado 
         * como pramitro
         * @param longitud 
         */
	...
	/**
         ...
         * las coordenadas x e y del tablero y si es así esa parteDanadas esta dañado o no
         * @param x column 
         * @param y fila
         */
